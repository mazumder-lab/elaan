...
parser = argparse.ArgumentParser(description='ELAAN-I on synthetic data.')
...
if args.dataset=='synthetic':
    ...
    #     print("TRAIN:", train_index, "VAL:", val_index)
        ...
        am.fit_validation_path(X_val, y_val)
...
am.generate_splines_and_quadratic_penalties(Ki=Ki, Kij=Kij)
if args.dataset=='synthetic':
    am.fit_validation_path(Xval=Xtrain, Yval=ytrain) # only matters when not running for single value.
elif args.dataset=='large-synthetic-correlated':
    am.fit_validation_path(Xval=Xval, Yval=yval)
