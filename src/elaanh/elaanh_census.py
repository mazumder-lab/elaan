...
parser = argparse.ArgumentParser(description='ELAAN-H: Additive Models with Interactions under Strong Hierarchy on Census data.')
...
lams_L0_start = 2
lams_L0_stop = -2
lams_L0 = np.logspace(start=lams_L0_start, stop=lams_L0_stop, num=20, base=10.0)
...
amish.fit_validation_path(Xval, Yval)
